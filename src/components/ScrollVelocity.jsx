...
// Fonction utilitaire simple pour combiner classes
function cn(...classes) {
...
// Context pour partager la vitesse
const ScrollVelocityContext = React.createContext(null);

// Container qui fournit la vitesse de scroll
...
// Composant Row qui utilise le context si disponible
...
// Version locale si pas de context
